...
(custom-theme-set-faces 'chong
 ...
 '(mode-line ((t (:background "SlateBlue3" :foreground "white" :weight bold :box (:line-width 2 :color "SlateBlue3")))))
 '(mode-line-inactive ((t (:background "selectedKnobColor" :foreground "white" :weight bold :box (:line-width 2 :color "selectedKnobColor")))))
 '(mode-line-buffer-id ((t (:background "IndianRed1" :foreground "white" :weight bold :box (:line-width 2 :color "IndianRed1")))))
